...
export async function renderResumePdf(
  ...
  switch (layout) {
    case "modern":
      doc = <ModernLayout data={data} palette={palette} />;
      break;
    case "minimal":
      doc = <MinimalLayout data={data} palette={palette} />;
      break;
    case "executive":
      doc = <ExecutiveLayout data={data} palette={palette} />;
      break;
    case "classic":
    default:
      doc = <ClassicLayout data={data} palette={palette} />;
      break;
  }
